...
{
    public class DP12MST_VCFileGenerator
    {
        #region Members


        private static DP12MST_VCFileGenerator m_instance = new DP12MST_VCFileGenerator();
        //private DP12MST_VCFileGenerator_BGWorker m_VCFileGenerator_BGWorker = null;
        private DP12MST_VCFileGenerator_Threads m_VCFileGenerator_Threads = null;
        ...
        /// Default Constructor
        /// </summary>
        private DP12MST_VCFileGenerator()
        {
            //m_VCFileGenerator_BGWorker = new DP12MST_VCFileGenerator_BGWorker();
            m_VCFileGenerator_Threads = new DP12MST_VCFileGenerator_Threads();
        ...
        /// </summary>
        /// <returns></returns>
        public static DP12MST_VCFileGenerator GetInstance()
        {
            return m_instance;
        }
