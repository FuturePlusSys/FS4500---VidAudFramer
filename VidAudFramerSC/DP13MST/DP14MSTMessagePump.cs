...
namespace DP14MSTClassLibrary
{
    ...
    /// </summary>
    public class DP14MSTMessage_ClearTraceBufferData : DP14MSTMessage
    {
        #region Members
        private DP14MST_TRACE_BUFFER_MODE m_TBModeID = DP14MST_TRACE_BUFFER_MODE.MainLink;

        public DP14MST_TRACE_BUFFER_MODE TBModeID
        {
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_ClearTraceBufferData(long id, DP14MST_TRACE_BUFFER_MODE TBMode)
        {
    ...
    /// Derived Display Port event containing an PM Running Event
    /// </summary>
    public class DP14MSTMessage_PMRunning : DP14MSTMessage
    {
        #region Members

        private DP14MST_TRACE_BUFFER_MODE m_runMode = DP14MST_TRACE_BUFFER_MODE.MainLink;
        public DP14MST_TRACE_BUFFER_MODE RunMode { get { return m_runMode; } set { m_runMode = value; } }
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_PMRunning(long id = 0, DP14MST_TRACE_BUFFER_MODE mode = DP14MST_TRACE_BUFFER_MODE.MainLink)
        {
            m_Name = "PMRunning";
            m_ID = id;
            m_runMode = mode;
    ...
    /// </summary>
    public class DP14MSTMessage_PMStopping_Request : DP14MSTMessage
    {
        #region Members
        #endregion // Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_PMStopping_Request(long id = 0)
        {
    ...
    /// Derived Display Port event containing an PM Ready Event
    /// </summary>
    public class DP14MSTMessage_PMStopping_Ack : DP14MSTMessage
    {
        #region Members
        #endregion // Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_PMStopping_Ack(long id = 0)
        {
    ...
    /// Derived Display Port event containing an PM Ready Event
    /// </summary>
    public class DP14MSTMessage_PMReady : DP14MSTMessage
    {
        #region Members
        #endregion // Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_PMReady(long id = 0)
        {
            m_Name = "PMReady";
            m_ID = id;
        }
    ...
    /// Derived Display Port event containing an PM Ready Event
    /// </summary>
    public class DP14MSTMessage_MemoryDepthChanged : DP14MSTMessage
    {
        #region Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_MemoryDepthChanged(long id = 0, long depth = 8192)
        {
            m_ID = id;
            m_memDepth = depth;
        }
    ...
    /// </summary>
    public class DP14MSTMessage_TimeSlotSelectionChanged : DP14MSTMessage
    {
        #region Members
        ...
        public DP14MSTMessage_TimeSlotSelectionChanged(int vChannelID, List<int> slotIDs)
        {
    ...
    //public class DP14MSTMessage_TriggerChannelChanged : DP14MSTMessage
    //{
    //    #region Members
    ...
    //    /// <param name="vChannelID"></param>
    //    /// <param name="slotIDs"></param>
    //    public DP14MSTMessage_TriggerChannelChanged(int triggerChannelID)
    //    {
    ...
    /// </summary>
    public class DP14MSTMessage_DataAvailable : DP14MSTMessage
    {
        #region Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_DataAvailable(long id = 0)
        {
    ...
    /// </summary>
    public class DP14MSTMessage_DataUploaded : DP14MSTMessage
    {
        #region Members
        #endregion // Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_DataUploaded(long id = 0)
        {
    ...
    /// Derived Display Port event containing an Data Ready Event
    /// </summary>
    public class DP14MSTMessage_DataReady : DP14MSTMessage
    {
        #region Members
        #endregion // Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_DataReady(long id = 0)
        {
            m_Name = "Data Ready";
            m_ID = id;
        }
    ...
    /// </summary>
    public class DP14MSTMessage_StateDataChunkRequest : DP14MSTMessage
    {
        #region Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_StateDataChunkRequest(long id = 0, int listingID = 0, int vChannelID = 1, long stateNumber = 0, int chunkSize = 4096, int dataOffset = 0)
        {
    ...
    /// Derived Display Port event containing an State Data Request Event
    /// </summary>
    public class DP14SSTMessage_StateDataRequest : DP14MSTMessage
    {
        #region Members
    ...
    /// Derived Display Port event containing an State Data Request Event
    /// </summary>
    public class DP14MSTMessage_StateDataRequest : DP14MSTMessage
    {
        #region Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_StateDataRequest(long id = 0, int vChannelID = 1, long stateNumber = 0, int dataOffset = 0)
        {
            m_Name = "State Data Request";
            m_ID = id;
            m_vChannelID = vChannelID;
    ...
    /// </summary>
    public class DP14MSTMessage_StateDataResponse : DP14MSTMessage
    {
        #region Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_StateDataResponse(long responseEventID, long requestEventID, int vChannelID, long stateNumber = 0, byte[] data = null)
        {
    ...
    /// </summary>
    public class DP14MSTMessage_GetStateData : DP14MSTMessage
    {
        #region Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_GetStateData(long id = 0, long stateIndex = 0)
        {
    ...
    /// </summary>
    public class DP14MSTMessage_ListingReady : DP14MSTMessage
    {
        #region Members
        #endregion // Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_ListingReady(long id = 0)
        {
    ...
    /// </summary>
    public class DP14MSTMessage_GetTBBinFileMetaData : DP14MSTMessage
    {
        #region Members

        // type of data being requested; mail or auxiliary
        private DP14MST_TRACE_BUFFER_MODE m_TBMode = DP14MST_TRACE_BUFFER_MODE.Unknown;
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_GetTBBinFileMetaData()
        {
        }
    ...
    /// Derived Display Port event containing an Data Available Event
    /// </summary>
    public class DP14MSTMessage_AuxDataAvailable : DP14MSTMessage
    {
        #region Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_AuxDataAvailable(long id = 0)
        {
    ...
    /// Derived Display Port event containing an Data Ready Event
    /// </summary>
    public class DP14MSTMessage_AuxDataReady : DP14MSTMessage
    {
        #region Members
        #endregion // Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_AuxDataReady(long id = 0)
        {
    ...
    /// Derived Display Port event containing an State Data Request Event
    /// </summary>
    public class DP14MSTMessage_AuxStateDataRequest : DP14MSTMessage
    {
        #region Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_AuxStateDataRequest(long id = 0, long stateNumber = 0, int dataOffset = 0)
        {
            m_Name = "State Data Request";
            m_ID = id;
            m_stateNumber = stateNumber;
    ...
    /// Derived Display Port event containing an State Data Response Event
    /// </summary>
    public class DP14MSTMessage_AuxStateDataResponse : DP14MSTMessage
    {
        #region Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_AuxStateDataResponse(long responseEventID, long requestEventID, long stateNumber = 0, byte[] data = null)
        {
            m_Name = "State Data Response";
            m_ID = responseEventID;
            m_requestID = requestEventID;
    ...
    /// Get the data assoicated state and return the data as a class property 
    /// </summary>
    public class DP14MSTMessage_AuxGetStateData : DP14MSTMessage
    {
        #region Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_AuxGetStateData(long id = 0, long stateIndex = 0)
        {
    ...
    /// </summary>
    public class DP14MSTMessage_SearchListingRequest : DP14MSTMessage
    {
        #region Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_SearchListingRequest(long id, DP14MST_TRACE_BUFFER_MODE TBMode, string columnName, uint columnValue, long stateIndex, bool searchBackwards)
        {
    ...
    /// </summary>
    public class DP14MSTMessage_SearchListingResponse : DP14MSTMessage
    {
        #region Members
        ...
        public DP14MSTMessage_SearchListingResponse(long id, long requestMsgID, DP14MST_TRACE_BUFFER_MODE TBMode, bool matchFound, long stateIndex)
        {
    ...
    /// </summary>
    public class DP14MSTMessage_SearchListingCancelRequest : DP14MSTMessage
    {
        #region Members
        ...
        /// <param name="TBMode"></param>
        /// <param name="stateIndex"></param>
        public DP14MSTMessage_SearchListingCancelRequest(long id, DP14MST_TRACE_BUFFER_MODE TBMode)
        {
    ...
    /// </summary>
    public class DP14MSTMessage_SearchListingCancelResponse : DP14MSTMessage
    {
        #region Members
        ...
        /// <param name="TBMode"></param>
        public DP14MSTMessage_SearchListingCancelResponse(long id, long requestMsgID, DP14MST_TRACE_BUFFER_MODE TBMode)
        {
    ...
    /// </summary>
    public class DP14MSTMessage_SearchListingProgessReport : DP14MSTMessage
    {
        #region Members
        ...
        public DP14MSTMessage_SearchListingProgessReport(DP14MST_TRACE_BUFFER_MODE TBMode, long statesSearched)
        {
    ...
    ///// </summary>
    //public class DP14MSTMessage_MarkerGetNextID : DP14MSTMessage
    //{
    //    #region Members

    //    private DP14MSTMarkerInfoID m_markerType = DP14MSTMarkerInfoID.Unknown;
    //    public DP14MSTMarkerInfoID MarkerType
    //    {
    ...
    //    /// Default Constructor
    //    /// </summary>
    //    public DP14MSTMessage_MarkerGetNextID(DP14MSTMarkerInfoID type)
    //    {
    ...
    ///// </summary>
    //public class DP14MSTMessage_MarkerAdd : DP14MSTMessage
    //{
    //    #region Members
    ...
    //    /// Default Constructor
    //    /// </summary>
    //    public DP14MSTMessage_MarkerAdd(long id = 0)
    //    {
    ...
    //    public DP14MSTMessage_MarkerAdd(long id, DP14MSTMarkerInfoID markerType, int vChannelID, string title, string markerID, long stateIndex)
    //    {
    //        m_Name = "TB Marker Add";
    //        m_ID = id;
    ...
    ///// </summary>
    //public class DP14MSTMessage_MarkerRemove : DP14MSTMessage
    //{
    //    #region Members
    ...
    //    /// Default Constructor
    //    /// </summary>
    //    public DP14MSTMessage_MarkerRemove(long id)
    //    {
    ...
    //    /// <param name="title"></param>
    //    /// <param name="markerID"></param>
    //    public DP14MSTMessage_MarkerRemove(long id, DP14MSTMarkerInfoID markerType, int vChannelID, string title, string markerID)
    //    {
    //        m_Name = "TB Marker Remove";
    //        m_ID = id;
    ...
    ///// Derived Display Port event containing a trace buffer marker add event
    ///// </summary>
    //public class DP14MSTMessage_MarkerChangeLocation : DP14MSTMessage
    //{
    //    #region Members
    ...
    //    /// <param name="title"></param>
    //    /// <param name="markerID"></param>
    //    public DP14MSTMessage_MarkerChangeLocation(long id, DP14MSTMarkerInfoID markerType, int vChannelID, string title, string markerID, int stateIndex)
    //    {
    ...
    ///// </summary>
    //public class DP14MSTMessage_MarkerGetList : DP14MSTMessage
    //{
    //    #region Members
    ...
    //    private List<DP14MSTMarkerInfo_MainLink> m_markerInfoList_mainLink = new List<DP14MSTMarkerInfo_MainLink>();
    //    public List<DP14MSTMarkerInfo_MainLink> MarkerInfoList_mainLink
    //    {
    //        get { return m_markerInfoList_mainLink; }
    //        set { m_markerInfoList_mainLink = value; }
    //    }

    //    private List<DP14MSTMarkerInfo_AuxiliaryLink> m_markerInfoList_auxiliaryLink = new List<DP14MSTMarkerInfo_AuxiliaryLink>();
    //    public List<DP14MSTMarkerInfo_AuxiliaryLink> MarkerInfoList_auxiliaryLink
    //    {
    ...
    //    /// <param name="title"></param>
    //    /// <param name="markerID"></param>
    //    public DP14MSTMessage_MarkerGetList(DP14MSTMarkerInfoID markerType, int vChannelID)
    //    {
    ...
    ///// </summary>
    //public class DP14MSTMessage_MarkerGetListResponse_MainLink : DP14MSTMessage
    //{
    //    #region Members

    //    private List<DP14MSTMarkerInfo_MainLink> m_markerList = new List<DP14MSTMarkerInfo_MainLink>();

    //    public List<DP14MSTMarkerInfo_MainLink> MarkerList
    //    {
    ...
    //    public DP14MSTMessage_MarkerGetListResponse_MainLink(List<DP14MSTMarkerInfo_MainLink> markerList)
    //    {
    ...
    ///// Derived Display Port event containing a marker list response event
    ///// </summary>
    //public class DP14MSTMessage_MarkerGetListResponse_AuxiliaryLink : DP14MSTMessage
    //{
    //    #region Members

    //    private List<DP14MSTMarkerInfo_AuxiliaryLink> m_markerList = new List<DP14MSTMarkerInfo_AuxiliaryLink>();

    //    public List<DP14MSTMarkerInfo_AuxiliaryLink> MarkerList
    //    {
    //        get { return m_markerList; }
    //        set { m_markerList = value; }
    //    }
    ...
    //    public DP14MSTMessage_MarkerGetListResponse_AuxiliaryLink(List<DP14MSTMarkerInfo_AuxiliaryLink> markerList)
    //    {
    ...
    /// </summary>
    public class DP14MSTMessage_TBDataModeChange : DP14MSTMessage
    {
        #region Members
        private DP14MST_TRACE_BUFFER_MODE m_TBModeID = DP14MST_TRACE_BUFFER_MODE.MainLink;
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_TBDataModeChange(long id, DP14MST_TRACE_BUFFER_MODE TBMode)
        {
    ...
    /// Derived Display Port event containing a trace buffer mode change event
    /// </summary>
    public class DP14MSTMessage_SpeedChange : DP14MSTMessage
    {
        #region Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_SpeedChange(long id, float clkPeriod)
        {
            m_Name = "Speed Change";
            m_ID = id;
    ...
    /// </summary>
    public class DP14MSTMessage_CrossLinkTriggerOrderChange : DP14MSTMessage
    {
        #region Members

        private DP14MST_CROSS_LINK_MODE m_mode = 0x00;

        public DP14MST_CROSS_LINK_MODE Mode
        {
            get { return m_mode; }
            set { m_mode = value; }
        }
        ...
        #region Constructor(s)
        public DP14MSTMessage_CrossLinkTriggerOrderChange(long id, DP14MST_CROSS_LINK_MODE mode)
        {
    ...
    /// </summary>
    public class DP14MSTMessage_Initialize : DP14MSTMessage
    {
        #region Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_Initialize(long id = 0, bool removeDataFiles = false)
        {
            m_Name = "Initialize";
            m_ID = id;
    ...
    /// </summary>
    public class DP14MSTMessage_SetConfig : DP14MSTMessage
    {
        #region Members
        #endregion // Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_SetConfig(long id = 0)
        {
            m_Name = "Set Config";
            m_ID = id;
        }
    ...
    /// Derived Display Port event containing an Set Configuration Message
    /// </summary>
    public class DP14MSTMessage_SaveConfig : DP14MSTMessage
    {
        #region Members
        #endregion // Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_SaveConfig(long id = 0)
        {
            m_Name = "Save Config";
            m_ID = id;
        }
    ...
    /// Derived Display Port event containing an Set Configuration Message
    /// </summary>
    public class DP14MSTMessage_LoadConfig : DP14MSTMessage
    {
        #region Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_LoadConfig(long id = 0, string filePath = "")
        {
            m_Name = "Load Config";
            m_ID = id;
    ...
    /// </summary>
    public class DP14MSTMessage_LoadConfigModule : DP14MSTMessage
    {
        #region Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_LoadConfigModule(long id = 0, string moduleID = "")
        {
    ...
    /// Derived Display Port event containing an Listing Ready Event
    /// </summary>
    public class DP14MSTMessage_TBObjectRegister : DP14MSTMessage
    {
        #region Members
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_TBObjectRegister(long id = 0, ITBObject TraceBufferObj = null)
        {
    ...
    /// </summary>
    public class DP14MSTMessage_GetNumberOfStates : DP14MSTMessage
    {
        ...
        /// Default Constructor
        /// </summary>
        public DP14MSTMessage_GetNumberOfStates( int virtualChannelID )
        {
    ...
    /// </summary>
    public class DP14MSTMessagePump
    {
        #region Members
        ...
        public void ForwardEvent(DP14MSTMessage e)
        {
            if ((e is DP14MSTMessage_TimeSlotSelectionChanged) ||
                (e is DP14MSTMessage_StateDataRequest) ||
                (e is DP14MSTMessage_AuxStateDataRequest) ||
                (e is DP14MSTMessage_AuxGetStateData) ||
                (e is DP14MSTMessage_GetTBBinFileMetaData) ||
                (e is DP14MSTMessage_SearchListingRequest) ||
                (e is DP14MSTMessage_GetStateData) ||
                (e is DP14MSTMessage_DataUploaded))
            {
                // send this to the TBDataMgr Object
                foreach (ITBObject obj in m_TBObjectsList)
                {
                    if (obj is DP14MSTTraceBufferDataMgr)
                    {
            ...
            //else if ((e is DP14MSTMessage_MarkerAdd) ||
            //         (e is DP14MSTMessage_MarkerRemove) ||
            //         (e is DP14MSTMessage_MarkerGetList) ||
            //         (e is DP14MSTMessage_MarkerGetNextID))
            //{
            //    foreach (ITBObject obj in m_TBObjectsList)
            //    {
            //        if (obj is DP14MSTMarkerInfoMgr)
            //        {
            //            obj.ProcessDPMessage(e);
            //            break;
            //        }
            //    }
            //}
            //else if (e is DP14MSTMessage_SpeedChange)
            //{
            //    foreach (ITBObject obj in m_TBObjectsList)
            //    {
            //        if (obj is DP14MSTStateListingForm)
            //        {
            //            obj.ProcessDPMessage(e);
            //            break;
            //        }
            //    }
            //}
            //else if (e is DP14MSTMessage_CrossLinkTriggerOrderChange)
            //{
            //    foreach (ITBObject obj in m_TBObjectsList)
            //    {
            //        if ((obj is DP14MSTProbeTrigForm) ||
            //            (obj is DP14MSTProbeAuxTrigForm))
            //        {
            //            obj.ProcessDPMessage(e);
            //        }
            //    }
            //}
            //else if (e is DP14MSTMessage_MarkerGetListResponse_MainLink)
            //{
            //    foreach (ITBObject obj in m_TBObjectsList)
            //    {
            //        if (obj is DP14MSTStateListingForm)
            ...
            //    }
            //}
            //else if (e is DP14MSTMessage_SearchListingResponse)
            //{
            //    if (((DP14MSTMessage_SearchListingResponse)e).TBMode == DP14MSTTRACE_BUFFER_MODE.MainLink)
            //    {
            //        foreach (ITBObject obj in m_TBObjectsList)
            //        {
            //            if (obj is DP14MSTStateListingForm)
            ...
            //        }
            //    }
            //    else if (((DP14MSTMessage_SearchListingResponse)e).TBMode == DP14MSTTRACE_BUFFER_MODE.AuxiliaryLink)
            //    {
            //        foreach (ITBObject obj in m_TBObjectsList)
            //        {
            //            if (obj is DP14MSTAuxStateListingForm)
            //            {
            //                obj.ProcessDPMessage(e);
            //                break;
            //            }
            ...
            //    }
            //}
            //else if (e is DP14MSTMessage_SearchListingCancelResponse)
            //{
            //    if (((DP14MSTMessage_SearchListingCancelResponse)e).TBMode == DP14MSTTRACE_BUFFER_MODE.MainLink)
            //    {
            //        foreach (ITBObject obj in m_TBObjectsList)
            //        {
            //            if (obj is DP14MSTStateListingForm)
            ...
            //        }
            //    }
            //    else if (((DP14MSTMessage_SearchListingCancelResponse)e).TBMode == DP14MSTTRACE_BUFFER_MODE.AuxiliaryLink)
            //    {
            //        foreach (ITBObject obj in m_TBObjectsList)
            //        {
            //            if (obj is DP14MSTAuxStateListingForm)
            ...
            //    }
            //}
            //else if (e is DP14MSTMessage_SearchListingProgessReport)
            //{
            //    if (((DP14MSTMessage_SearchListingProgessReport)e).TBMode == DP14MSTTRACE_BUFFER_MODE.MainLink)
            //    {
            //        foreach (ITBObject obj in m_TBObjectsList)
            //        {
            //            if (obj is DP14MSTStateListingForm)
            ...
            //        }
            //    }
            //    else if (((DP14MSTMessage_SearchListingProgessReport)e).TBMode == DP14MSTTRACE_BUFFER_MODE.AuxiliaryLink)
            //    {
            //        foreach (ITBObject obj in m_TBObjectsList)
            //        {
            //            if (obj is DP14MSTAuxStateListingForm)
            ...
            //    }
            //}
            //else if (e is DP14MSTMessage_MarkerGetListResponse_AuxiliaryLink)
            //{
            //    foreach (ITBObject obj in m_TBObjectsList)
            //    {
            //        if (obj is DP14MSTAuxStateListingForm)
