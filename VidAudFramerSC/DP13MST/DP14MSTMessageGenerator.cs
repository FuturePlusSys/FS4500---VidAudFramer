...
namespace DP14MSTClassLibrary
{
    ...
    /// </summary>
    public class DP14MSTMessageGenerator
    {
        #region Members

        private static DP14MSTMessageGenerator m_instance = new DP14MSTMessageGenerator();
        private uint m_ID = 0;
        ...
        private DP14MSTMessageGenerator()
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static DP14MSTMessageGenerator GetInstance()
        {
            return m_instance;
        }
        ...
        /// <returns></returns>
        public DP14MSTMessage_TBObjectRegister DP14MSTMessageCreate_Register(ITBObject TBObjRef)
        {
            return (new DP14MSTMessage_TBObjectRegister(m_ID++, TBObjRef));
        }
        ...
        public DP14MSTMessage_GetTBBinFileMetaData DP14MSTMessageCreate_GetTBBinFileMetaData()
        {
            return (new DP14MSTMessage_GetTBBinFileMetaData());
        }
        ...
        /// <returns></returns>
        public DP14MSTMessage_StateDataChunkRequest DP14MSTMessageCreate_StateDataChunkRequest(int listingID, int vChannelID, long stateNumber, int chunkSize, int dataOffset = 0)
        {
            return (new DP14MSTMessage_StateDataChunkRequest(m_ID++, listingID, vChannelID, stateNumber, chunkSize, dataOffset));  
        }
        ...
        /// <param name="TBObj"></param>
        /// <returns></returns>
        public DP14MSTMessage_StateDataResponse DP14MSTMessageCreate_StateDataResponse(long requestID, int vChannelID, long stateNumber, byte[] data)
        {
            return (new DP14MSTMessage_StateDataResponse(m_ID++, requestID, vChannelID, stateNumber, data));
        }
        ...
        /// <returns></returns>
        public DP14MSTMessage_GetStateData DP14MSTMessage_GetStateData(long requestID, long stateNumber)
        {
            return (new DP14MSTMessage_GetStateData(m_ID++, stateNumber));
        }
