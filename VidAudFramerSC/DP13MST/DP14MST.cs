...
namespace DP14MSTClassLibrary
{
    ...
    public enum DP14MST_TRACE_BUFFER_MODE { MainLink, AuxiliaryLink, Both, Unknown }

    public enum DP14MST_CROSS_LINK_MODE { AuxiliaryLink, MainLink, Unknown }

    public class DP14MST : IProbeMgrGen2
    {
        #region Members
        ...
        private static DP14MSTMessagePump m_eventPump;
        private static DP14MSTTraceBufferDataMgr m_TBDataMgr;
        private DP14MSTMessageGenerator m_DP14MSTMessageGenerator = null;
        ...
        /// Default Constructor
        /// </summary>
        public DP14MST(string path)
        {
            m_eventPump = new DP14MSTMessagePump();

            m_TBDataMgr = new DP14MSTTraceBufferDataMgr(path);
            m_TBDataMgr.DisplayPort12MSTEvent += new DP14MSTEvent(processDPEvent);
            m_DP14MSTMessageGenerator = DP14MSTMessageGenerator.GetInstance();
        }
        ...
        /// <param name="e"></param>
        private void processDPEvent(object sender, DP14MSTEventArgs e)
        {
            if (e.Message is DP14MSTMessage_TBObjectRegister)
            {
                DP14MSTMessage_TBObjectRegister regEvent = e.Message as DP14MSTMessage_TBObjectRegister;
                m_eventPump.AddTBObjectRef(regEvent.TBObj);
            }
            else if (e.Message is DP14MSTMessage_StateDataResponse)
            {
        ...
        /// <returns></returns>
        private bool extractStateDataFromResponseMessage(DP14MSTMessage DisplayPortEvent)
        {
            bool status = true;
            ...
            if (m_stateData == null)
            {
                m_stateData = new byte[((DP14MSTMessage_StateDataResponse)DisplayPortEvent).DataBytes.Length];
            }
            else if ((m_stateData.Length == ((DP14MSTMessage_StateDataResponse)DisplayPortEvent).DataBytes.Length))
            {
                Array.ConstrainedCopy(((DP14MSTMessage_StateDataResponse)DisplayPortEvent).DataBytes, 0, m_stateData, 0, ((DP14MSTMessage_StateDataResponse)DisplayPortEvent).DataBytes.Length);
            }
            else
            {
                m_stateData = new byte[((DP14MSTMessage_StateDataResponse)DisplayPortEvent).DataBytes.Length];
        ...
        public bool Configure(int deviceNum, string serialNumberStr, bool inDemoMode)
        {
            ...
            //analyzerType = DP14MST_LA_TYPE.agilent;
        ...
        public bool Initialize()
        {
            ...
            m_TBDataMgr.LoadModuleConfig("Config_DP14MSTTraceBufferDataMgrForm.xml");  // should we make an additional IProbeMgr I/F method to load the module?
        ...
        {
            DP14MSTMessage msg = m_DP14MSTMessageGenerator.DP14MSTMessageCreate_GetTBBinFileMetaData();
            ((DP14MSTMessage_GetTBBinFileMetaData)msg).TBMode = DP14MST_TRACE_BUFFER_MODE.MainLink;  // main or auxiliary link
            ((DP14MSTMessage_GetTBBinFileMetaData)msg).VChannelID = 1;
            ...
            return ((DP14MSTMessage_GetTBBinFileMetaData)msg).VChannelID;
        }
        ...
        public long GetTriggerStateIndex(int virtualChannelID)
        {
            ...
            DP14MSTMessage msg = m_DP14MSTMessageGenerator.DP14MSTMessageCreate_GetTBBinFileMetaData();
            ((DP14MSTMessage_GetTBBinFileMetaData)msg).TBMode = DP14MST_TRACE_BUFFER_MODE.MainLink;  // main or auxiliary link
            ((DP14MSTMessage_GetTBBinFileMetaData)msg).VChannelID = virtualChannelID;
            ...
            {
                case 0:
                    index = ((DP14MSTMessage_GetTBBinFileMetaData)msg).TriggerOffset;
                    break;

                case 1:
                    index = ((DP14MSTMessage_GetTBBinFileMetaData)msg).VChannel1TrigIndex;
                    break;

                case 2:
                    index = ((DP14MSTMessage_GetTBBinFileMetaData)msg).VChannel2TrigIndex;
                    break;

                case 3:
                    index = ((DP14MSTMessage_GetTBBinFileMetaData)msg).VChannel3TrigIndex;
                    break;

                case 4:
                    index = ((DP14MSTMessage_GetTBBinFileMetaData)msg).VChannel4TrigIndex;
                    break;
        ...
        public long GetNumberOfStates(int virtualChannelID)
        {
            ...
            return (((DP14MSTMessage_GetTBBinFileMetaData)msg).NumberOfStates);
        }
        ...
        public byte[] GetStateData(int virtualChannelID, int index)
        {
            ...
            DP14MSTMessage_GetStateData msg = new DP14MSTMessage_GetStateData(0, index);
        ...
        {
            DP14MSTMessage_StateDataChunkRequest msg = m_DP14MSTMessageGenerator.DP14MSTMessageCreate_StateDataChunkRequest(0, VChannelID, startIndex, chunkSize);
    ...
    public delegate void DP14MSTEvent(object sender, DP14MSTEventArgs e);

    /// <summary>
    /// Derived Event Args used to contain DP Message objects 
    /// </summary>
    public class DP14MSTEventArgs : EventArgs
    {
        public DP14MSTMessage Message;

        public DP14MSTEventArgs(DP14MSTMessage message)
        {
